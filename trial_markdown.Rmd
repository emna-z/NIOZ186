...
t3$polymer_photo <- if_else(t3$material=="wood", str_c(t3$material,"_",t3$treatment), t3$polymer_photo)
t3$pol_photo_station <- if_else(t3$material=="wood", str_c(t3$material,"_",t3$treatment,"_",t3$station), t3$pol_photo_station)
